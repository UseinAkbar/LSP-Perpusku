...
<div class="col-xl-3 col-md-6 mb-4">
    ...
    <div class="card" style="background-color: #61677A;">
        <div class="container pl-5 ml-0">
            <h3 class="text-light my-3 ml-4">
                <i class="fa-solid fa-circle-info text-light"></i> Aturan Peminjaman Buku
            </h3>
            <ol class=text-light>
                <li class=text-light>Waktu peminjaman maksimal 5 hari</li>
                <li class=text-light>Setiap anggota hanya dapat meminjam maksimal 2 buku</li>
                <li class=text-light>Jika pengenbalian buku lebih dari waktu yang ditentukan akan dikenai denda.</li>
                <li class=text-light>Jika telah meminjam buku, silakan ke tempat petugas untuk melakukan konfirmasi</li>
                <li class=text-light>Lakukan pengembalian buku dengan melapor kepada petugas</li>
            </ol>
        </div>
    </div>
@endsection

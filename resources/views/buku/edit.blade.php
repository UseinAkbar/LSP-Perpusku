        ...
        <div class="card-body">
            <form action="/buku/{{ $buku->id }}" method="post"enctype="multipart/form-data">
                ...
                <div class="form-group mb-3">
                    ...
                    <select class="form-control" label="Pilih Kategori" name="kategori_buku[]" id="multiselect" multiple="multiple">
                ...
                <div class="form-group mb-3">
                    ...
                    <textarea class="form-control" name="deskripsi" rows="10">{{ old('deskripsi', $buku->deskripsi) }}</textarea>
                </div>

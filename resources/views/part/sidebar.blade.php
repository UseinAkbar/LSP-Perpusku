<ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
    <a class="sidebar-brand bg-navbar d-flex align-items-center justify-content-center" href="/home">
        <div class="sidebar-brand-icon">
            <img src="{{ asset('/img/logo.png') }}" width='60' height='60' style="object-fit:cover;">
        </div>
    ...
    @if (Auth::user()->isAdmin == 1)
        <li class="nav-item">
            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTable"
                ...
                <span class='text-dark'>Anggota</span>
            </a>
        ...
        <li class="nav-item">
            ...
            <div id="collapsePeminjam" class="collapse" aria-labelledby="headingPeminjam"
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="/peminjaman/create">Tambah Peminjaman</a>
    ...
    @if (Auth::user()->isAdmin == 0)
        <li class="nav-item">
            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePeminjam"
                ...
                <span class='text-dark'>Pinjam Buku</span>
            </a>
            <div id="collapsePeminjam" class="collapse" aria-labelledby="headingPeminjam"
                data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
